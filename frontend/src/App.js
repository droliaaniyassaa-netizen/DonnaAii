      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="main-tabs">
        ...
        <TabsContent value="chat" className="consciousness-container">
          <div className="consciousness-interface">
            ...
            {/* Donna's Consciousness Orb */}
            <div className="consciousness-presence">
              <div className={`donna-consciousness ${isLoading ? 'thinking' : isListening ? 'listening' : 'idle'}`}>
                <div className="donna-orb-hero">
                  <div className="orb-wrap">
                    <svg className="orb-svg" viewBox="0 0 600 600" aria-hidden="true">
                      <defs>
                        {/* 1) CORE GLOW (purple heart) */}
                        <radialGradient id="coreGlow" cx="50%" cy="50%" r="60%">
                          {/* hotter magenta at center, fades to transparent */}
                          <stop offset="0%" stopColor="#FF3BFF" stopOpacity="1"/>
                          <stop offset="20%" stopColor="#C92BFF" stopOpacity="0.95"/>
                          <stop offset="48%" stopColor="#8622F6" stopOpacity="0.75"/>
                          <stop offset="70%" stopColor="#4513CC" stopOpacity="0.30"/>
                          <stop offset="100%" stopColor="#140A33" stopOpacity="0"/>
                        </radialGradient>

                        {/* 2) LINE STROKE GRADIENT (purple body → electric blue rim) */}
                        <linearGradient id="lineGrad" x1="25%" y1="15%" x2="85%" y2="85%">
                          <stop offset="0%" stopColor="#B12BFF"/>   {/* purple */}
                          <stop offset="55%" stopColor="#7A2BFF"/>   {/* violet */}
                          <stop offset="100%" stopColor="#0BB2FF"/>   {/* blue */}
                        </linearGradient>

                        {/* 3) BULGE / LIVING WOBBLE (low-frequency, asymmetric) */}
                        <filter id="bulge" x="-35%" y="-35%" width="170%" height="170%">
                        ...
                        {/* 4) HARDER BULGE FOR THE DOT RINGS ONLY (keeps aura smooth) */}
                        <filter id="bulgeRings" x="-40%" y="-40%" width="180%" height="180%">
                          <feTurbulence type="fractalNoise"
                                        baseFrequency="0.0018 0.0068"
                                        numOctaves="2"
                                        seed="223">
                            {/* subtle breathing (very slow) */}
                            <animate attributeName="baseFrequency"
                                     values="0.0018 0.0068; 0.0024 0.0056; 0.0018 0.0068"
                                     dur="14s" repeatCount="indefinite"/>
                          </feTurbulence>
                          <feDisplacementMap in="SourceGraphic" scale="28"/>
                        </filter>

                        {/* 5) VIGNETTE HALO (tight, no smoke) */}
                        <radialGradient id="halo" cx="50%" cy="50%" r="55%">
                          <stop offset="0%" stopColor="rgba(23,0,60,0.0)"/>
                          <stop offset="65%" stopColor="rgba(12,0,80,0.25)"/>
                          <stop offset="100%" stopColor="rgba(0,0,0,0)"/>
                        </radialGradient>
                      </defs>

                      {/* BACKGROUND HALO (very subtle, keeps the pop without haze) */}
                      <rect x="0" y="0" width="600" height="600" fill="url(#halo)"></rect>

                      {/* CORE PURPLE AURA (sits beneath the dotted rings) */}
                      <g filter="url(#bulge)">
                        <circle cx="300" cy="310" r="215" fill="url(#coreGlow)"></circle>
                      </g>

                      {/* DOTTED RINGS (the "galaxy" look) */}
                      <g filter="url(#bulgeRings)" stroke="url(#lineGrad)" fill="none" strokeLinecap="round" opacity="0.98">
                        {/* INNER rings: tighter spacing, slightly faster offset */}
                        <circle cx="300" cy="300" r="58" strokeWidth="1.0" strokeDasharray="0.16 6.3">
                          <animate attributeName="stroke-dashoffset" dur="7.2s" values="0;128" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="74" strokeWidth="1.0" strokeDasharray="0.18 6.7">
                          <animate attributeName="stroke-dashoffset" dur="7.8s" values="0;140" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="90" strokeWidth="1.05" strokeDasharray="0.20 7.1">
                          <animate attributeName="stroke-dashoffset" dur="8.2s" values="0;154" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="106" strokeWidth="1.05" strokeDasharray="0.22 7.4">
                          <animate attributeName="stroke-dashoffset" dur="8.8s" values="0;168" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="122" strokeWidth="1.1" strokeDasharray="0.24 7.7">
                          <animate attributeName="stroke-dashoffset" dur="9.4s" values="0;184" repeatCount="indefinite"/>
                        </circle>

                        {/* MIDDLE rings: main body, densest "galaxy" field */}
                        <circle cx="300" cy="300" r="138" strokeWidth="1.1" strokeDasharray="0.26 8.0">
                          <animate attributeName="stroke-dashoffset" dur="10s" values="0;198" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="154" strokeWidth="1.15" strokeDasharray="0.28 8.3">
                          <animate attributeName="stroke-dashoffset" dur="10.8s" values="0;214" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="170" strokeWidth="1.2" strokeDasharray="0.30 8.6">
                          <animate attributeName="stroke-dashoffset" dur="11.6s" values="0;228" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="186" strokeWidth="1.25" strokeDasharray="0.32 8.9">
                          <animate attributeName="stroke-dashoffset" dur="12.4s" values="0;246" repeatCount="indefinite"/>
                        </circle>

                        {/* OUTER rings: slightly wider gap; preserves clean edge (blue rim) */}
                        <circle cx="300" cy="300" r="202" strokeWidth="1.25" strokeDasharray="0.34 9.3">
                          <animate attributeName="stroke-dashoffset" dur="13.2s" values="0;262" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="218" strokeWidth="1.3" strokeDasharray="0.36 9.6">
                          <animate attributeName="stroke-dashoffset" dur="14s" values="0;280" repeatCount="indefinite"/>
                        </circle>
                        <circle cx="300" cy="300" r="234" strokeWidth="1.35" strokeDasharray="0.38 10.0">
                          <animate attributeName="stroke-dashoffset" dur="14.8s" values="0;300" repeatCount="indefinite"/>
                        </circle>
                      </g>
                    </svg>
                  </div>
